    ...
    <div className="flex h-full w-full select-none flex-col justify-between overflow-hidden px-4 py-3">
      <div className="text-start" onClick={switchTheme}>
        ...
        <div className="flex cursor-pointer items-center gap-2">
          <IconButton className="h-8 w-8 rounded-full p-2" variant={theme === 'light' ? 'filled' : 'text'} ripple={false} placeholder={undefined}>
            <Player
      ...
      >
        ...
        <div className="flex cursor-pointer items-center gap-2">
          <animated.div style={{ ...springs }}>
            <IconButton className="h-8 w-8 rounded-full p-4" variant="text" ripple={false} placeholder={undefined}>
